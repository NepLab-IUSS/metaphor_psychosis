...
- "threshold in partenza" su item IPASE: dove lo vogliamo mettere?
- correlazione con APACS/PMM z-scored
- mini legenda con item titoli e testo (non so dove metterla, pero' la vedi nella prima cella)
- non so se il file con annotazione dei source sia definitivo o se
  Maddalena e Carola stiano ancora rivedendo l'annotazione